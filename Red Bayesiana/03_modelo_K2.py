...
# MODELO K2  
# Tarda mucho en cargar y da errores usando el código como el de modelo.py. 
# Sin embargo, con max_indegree=4 da una precisión de 74%
...
model = hc.estimate(scoring_method='k2', max_indegree=7)
